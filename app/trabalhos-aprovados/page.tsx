...
const trabalhosPorEixo: Record<EixoNum, Trabalho[]> = {
  1: [
    { titulo: 'Planejamento de ações de educação permanente em saúde digital a partir de diagnóstico situacional: relato de experiência de um PET-Saúde', sala: 'Sala 2402' },
    { titulo: 'Desenvolvimento de glossário de termos de informação e saúde digital: estudo metodológico', sala: 'Sala 2402' },
    { titulo: 'Acesso à informação em saúde digital entre usuários na atenção primária: resultados parciais', sala: 'Sala 2402' },
    { titulo: 'Chatbot sobre diabetes como tecnologia educacional no PET-Saúde Informação & Saúde Digital', sala: 'Sala 2402' },
    { titulo: 'Oficina sobre utilização dos relatórios do CELK na atenção primária à saúde', sala: 'Sala 2402' },
    { titulo: 'Autoconfiança na compreensão e aplicação de informações de saúde online entre usuários de Estratégias Saúde da Família do município de Uruguaiana', sala: 'Sala 2402' },
    { titulo: 'Educação permanente na atenção primária à saúde: experiência de uma preceptora do PET-Saúde Digital', sala: 'Sala 2402' },
    { titulo: 'Competências ético-digitais: desafios na formação e da atenção primária sob a égide da LGPD', sala: 'Sala 2402' },
    { titulo: 'LGPD e saúde pública: transparência no tratamento de dados e direitos dos pacientes', sala: 'Sala 2402' },
    { titulo: 'Rodas de conversa como estratégia de divulgação do App SAU para usuários do SUS', sala: 'Sala 2402' },
  ...
  2: [
    { titulo: 'Medicamento correto no horário correto, mantendo uma saúde correta.', sala: 'Sala 2404' },
    { titulo: 'SICOM-Jaguari: identificação de demandas do serviço de saúde para o desenvolvimento de tecnologia digital', sala: 'Sala 2404' },
    { titulo: 'Construção colaborativa de solução digital para organização do fluxo de atendimento na atenção primária Itaqui-RS', sala: 'Sala 2404' },
    { titulo: 'Elicitação de requisitos para um sistema de chamada de pacientes na atenção primária à saúde', sala: 'Sala 2404' },
    { titulo: 'ChamaSUS: sistema web para gerenciamento de filas e chamada de pacientes integrado ao e-SUS', sala: 'Sala 2404' },
    { titulo: 'Ferramenta de triagem em saúde com inteligência artificial no App SAU', sala: 'Sala 2404' },
    { titulo: 'Relato de experiência na validação de plataforma digital para imunização no SUS', sala: 'Sala 2404' },
    { titulo: 'Engenharia de software integrada à saúde digital no SUS: relato de experiência no PET-Saúde e-Cidadania', sala: 'Sala 2404' },
    { titulo: 'Modelagem computacional preditiva aplicada à triagem de diabetes mellitus em saúde digital', sala: 'Sala 2404' },
    { titulo: 'Desenvolvimento de inteligência artificial para análise de ultrassonografia mamária no SUS: relato de experiência', sala: 'Sala 2404' },
    { titulo: 'RegulaAE: sistema web para regulação da atenção especializada', sala: 'Sala 2404' },
  ...
  3: [
    { titulo: 'Sífilis gestacional e congênita em Uruguaiana, Rio Grande do Sul: estudo ecológico', sala: 'Sala 2406' },
    { titulo: 'Tendência temporal das internações por câncer de traqueia, brônquios e pulmões no RS (2008–2025)', sala: 'Sala 2406' },
    { titulo: 'Tendência temporal da idade gestacional nas notificações de sífilis gestacional (2013–2023)', sala: 'Sala 2406' },
    { titulo: 'Mortalidade evitável e prioridades territoriais em saúde: análise de dados do SIM/DATASUS no Rio Grande do Sul', sala: 'Sala 2406' },
    { titulo: 'Análise de nascimentos e pré-natal no OlharSUS Pampa', sala: 'Sala 2406' },
    { titulo: 'Estratégias para implementação da LGPD no Sistema Único de Saúde: uma revisão de literatura', sala: 'Sala 2406' },
    { titulo: 'Monitoramento da cobertura de exames preventivos femininos com dados públicos do SUS', sala: 'Sala 2406' },
    { titulo: 'OlharSUS Pampa Lakehouse: arquitetura open source para integração e governança de dados no SUS regional', sala: 'Sala 2406' },
